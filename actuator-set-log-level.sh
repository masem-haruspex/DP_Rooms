...
if [ $# -lt 1 ]; then
  ...
  echo "Package groups:"
  echo "  myapp      - Your application only (com.mm_mk.Rooms)"
...
BASE_URL="http://localhost:9002/actuator/loggers"
USERNAME="admin"
PASSWORD="admin123"
LOG_LEVEL=$1
GROUP=${2:-"all"}  # Default: all important packages
...
declare -A PACKAGE_GROUPS=(
  ...
  ["all"]="com.mm_mk.Rooms org.springframework.security org.springframework.web org.springframework.boot org.springframework.transaction org.hibernate.SQL org.hibernate.type.descriptor.sql org.springframework.jdbc.core org.apache.tomcat org.apache.catalina"
)
